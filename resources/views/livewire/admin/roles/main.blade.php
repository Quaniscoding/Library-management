...
<main class="flex-1 overflow-y-auto p-6 bg-white dark:bg-gray-900 dark:text-gray-200" wire:poll.1s>
    <h1 class="text-center font-bold text-2xl mb-6 dark:text-white">Quản lý Roles</h1>

    <!-- Button Tạo Roles Mới -->
        ...
        <table class="table-auto w-full border-collapse border border-gray-300 dark:border-gray-700">
            ...
            <tbody>
                ...
                <tr class="hover:bg-gray-100 dark:hover:bg-gray-700">
                    <td class="border border-gray-300 px-4 py-2 text-center dark:border-gray-600">{{ $role->id }}</td>
                    <td class="border border-gray-300 px-4 py-2 text-center dark:border-gray-600">{{ $role->name }}</td>
        ...
        <div class="bg-white rounded-lg shadow-lg p-6 w-1/3 dark:bg-gray-800 dark:text-white">
            <div class="flex justify-between">
                <h2 class="text-xl font-bold mb-4">
                    {{ $isEditMode ? 'Cập nhật Roles' : 'Tạo Roles mới' }}
                </h2>
            ...
            <!-- Form -->
            <form wire:submit.prevent="{{ $isEditMode ? 'updateRole' : 'createRole' }}" class="h-auto overflow-auto">
                <div class="mb-4">
                    <label for="name" class="block font-semibold">Tên role</label>
    ...
    <div x-data="{ open: @entangle('isConfirmModalOpen') }" x-show="open"
        ...
        <div class="bg-white rounded-lg shadow-lg p-6 w-1/3 dark:bg-gray-800 dark:text-white">
            ...
            <p class="text-center mb-6 dark:text-gray-300">Bạn có chắc chắn muốn xóa roles này không?</p>

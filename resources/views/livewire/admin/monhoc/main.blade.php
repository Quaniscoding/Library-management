...
<main class="flex-1 overflow-y-auto p-6 bg-white dark:bg-gray-900 text-gray-900 dark:text-gray-100" wire:poll.10s>
        ...
        <div class="flex justify-between">
            <div class="mb-4 flex justify-start">
                <input type="text" wire:model.live="searchName" placeholder="Tìm kiếm theo tên"
                    class="border border-gray-300 dark:border-gray-600 px-4 py-2 rounded-md focus:outline-none dark:bg-gray-800 dark:text-white" />
            </div>
        </div>
        ...
        <table class="table-auto w-full border-collapse border border-gray-300 dark:border-gray-600">
            <thead class="bg-gray-100 dark:bg-gray-700">
                <tr>
                    ...
                    <th class="border border-gray-300 dark:border-gray-600 px-4 py-2">Tên Môn</th>
            ...
            <tbody>
                ...
                <tr class="hover:bg-gray-100 dark:hover:bg-gray-800">
                    <td class="border border-gray-300 dark:border-gray-600 px-4 py-2 text-center">{{ $monhoc->id }}</td>
                    <td class="border border-gray-300 dark:border-gray-600 px-4 py-2 text-center">{{ $monhoc->ten_mon }}
                    </td>
                ...
                @empty
                <tr>
                    <td colspan="6" class="border border-gray-300 dark:border-gray-600 px-4 py-2 text-center">Không có
                        dữ liệu môn.</td>
                </tr>
                @endforelse
            </tbody>
        ...
        <div class="bg-white dark:bg-gray-800 rounded-lg shadow-lg p-6 w-1/3">
            <div class="flex justify-between">
                ...
                <button type="button" wire:click="closeModal"
                    class="w-10 h-10 bg-gray-500 dark:bg-gray-700 text-white text-xl rounded-full flex items-center justify-center hover:bg-gray-600 dark:hover:bg-gray-600 focus:outline-none transition-transform transform hover:scale-110">
                    X
                </button>
            </div>
            ...
            <form wire:submit.prevent="{{ $isEditMode ? 'updateMonHoc' : 'createMonHoc' }}"
                ...
                <div class="flex justify-end space-x-2">
                    <button type="button" wire:click="closeModal"
                        class="bg-gray-500 dark:bg-gray-700 text-white px-4 py-2 rounded-md hover:bg-gray-600 dark:hover:bg-gray-600">Huỷ</button>
                    <button type="submit"
                        class="bg-blue-600 dark:bg-blue-500 text-white px-4 py-2 rounded-md hover:bg-blue-700 dark:hover:bg-blue-600">Lưu</button>
                </div>
            </form>
        </div>
    </div>
    ...
    <div x-data="{ open: @entangle('isConfirmModalOpen') }" x-show="open"
        ...
        <div class="bg-white dark:bg-gray-800 rounded-lg shadow-lg p-6 w-1/3">
            ...
            <p class="text-center mb-6">Bạn có chắc chắn muốn xóa môn này không?</p>
            <p class="text-center mb-6">Thao tác này không thể hoàn tác.</p>
            <div class="flex justify-center space-x-4">
                <button type="button" wire:click="closeConfirmModal"
                    class="bg-gray-500 dark:bg-gray-700 text-white px-4 py-2 rounded-md hover:bg-gray-600 dark:hover:bg-gray-600">Huỷ</button>
                <button type="button" wire:click="deleteMonHoc"
                    class="bg-red-600 dark:bg-red-500 text-white px-4 py-2 rounded-md hover:bg-red-700 dark:hover:bg-red-600">Xóa</button>
            </div>
        </div>
    </div>
    ...
    <div class="flex justify-center mt-6">
        <div class="inline-flex items-center space-x-2">
            ...
            <a href="{{ $monhocs->previousPageUrl() }}"
                class="px-4 py-2 text-white bg-blue-600 dark:bg-blue-500 rounded-md hover:bg-blue-700 dark:hover:bg-blue-600"><i class="fa-solid fa-backward"></i></a>
            @endif
            ...
            <a href="{{ $monhocs->nextPageUrl() }}"
                class="px-4 py-2 text-white bg-blue-600 dark:bg-blue-500 rounded-md hover:bg-blue-700 dark:hover:bg-blue-600"><i class="fa-solid fa-forward"></i></a>
            @else

...
<main class="flex-1 overflow-y-auto p-6 bg-white dark:bg-gray-900 dark:text-white" wire:poll.10s>
        ...
        <div class="flex justify-between">
            <div class="mb-4 flex justify-start">
                <input type="text" wire:model.live="searchName" placeholder="Tìm kiếm theo tên"
                    class="border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-800 dark:text-white px-4 py-2 rounded-md focus:outline-none" />
            </div>
        </div>
        ...
        <table class="table-auto w-full border-collapse border border-gray-300 dark:border-gray-600">
            <thead class="bg-gray-100 dark:bg-gray-800">
                <tr>
                    ...
                    <th class="border border-gray-300 dark:border-gray-600 px-4 py-2">Vị Trí</th>
            ...
            <tbody>
                ...
                <tr class="hover:bg-gray-100 dark:hover:bg-gray-700">
                    <td class="border border-gray-300 dark:border-gray-600 px-4 py-2 text-center">{{ $cuonsach->id }}
                    </td>
                    <td class="border border-gray-300 dark:border-gray-600 px-4 py-2 text-center">{{
                        $cuonsach->sach->ten_sach }}</td>
                    <td class="border border-gray-300 dark:border-gray-600 px-4 py-2 text-center">
    ...
    <div x-data="{ open: @entangle('isConfirmModalOpen') }" x-show="open"
        ...
        <div class="bg-white dark:bg-gray-800 rounded-lg shadow-lg p-6 w-1/3">
            ...
            <p class="text-center mb-6">Bạn có chắc chắn muốn xóa cuốn sách này không?</p>
    ...
    <div class="flex justify-center mt-6">
        <div class="inline-flex items-center space-x-2">
            ...
            <a wire:click.prevent="gotoPage({{ $page }})" href="#"
                class="{{ $page == $cuonsachs->currentPage() ? 'bg-blue-600 text-white dark:bg-blue-500' : 'text-blue-600 border border-gray-300 dark:border-gray-600 hover:bg-gray-100 dark:hover:bg-gray-700' }} px-4 py-2 rounded-md">
                {{ $page }}
            </a>
            @endforeach

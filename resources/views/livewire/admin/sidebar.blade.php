<!-- Sidebar -->
<aside
    class="bg-white dark:bg-gray-700 dark:text-white w-full md:w-64 min-h-[80vh] m flex flex-col justify-between ml-2 shadow-md rounded-md">
    <!-- Header & Navigation -->
    <div>
        <!-- Header -->
        <div
    ...
    <div class="border-t border-gray-300 dark:border-gray-600 min-h-[200px]">
        <div class="px-4 py-3">
